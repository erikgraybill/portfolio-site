...
export default function Home() {
  return (
    <div>
      <section id="profile" className="md:relative h-screen">
        <div className="sm:flex block justify-center gap-[5rem] md:pt-30 mx-6">
          ...
          <div className="self-center text-center mt-2">
            ...
            <p className="md:text-lg">This site is a work in progress...more to come!</p>
          </div>
        </div>
      ...
      <section id="projects" className="relative h-screen md:text-lg md:mb-0 mb-55">
        ...
        <div className="justify-center">
          <div className="md:flex block gap-8 mb-8 mt-4 mx-5">
            <div className="my-5 p-4 flex-[1] border rounded-4xl border-erg-second-accent-tan text-center">
              <p className="text-2xl font-bold text-erg-primary-accent-green mb-4">Document Splitting and Naming using OCR</p>
            ...
            <div className="my-5 p-4 flex-[1] border rounded-4xl border-erg-second-accent-tan text-center">
              <p className="text-2xl font-bold text-erg-primary-accent-green mb-4"><span className="">OneStop</span> Application Development</p>
              <div className="flex flex-wrap flex-row gap-2 justify-around text-left">
